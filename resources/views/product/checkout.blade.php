        ...
        <div class="col-md-5 order-md-1">
            ...
            <div class="mb-3">
                ...
                {{-- <input type="text" class="form-control ch" id="addr" placeholder="Địa chỉ cụ thể"
                    required=""> --}}
                    <textarea class="form-control ch"  required="" id="addr" placeholder="Địa chỉ cụ thể" name="address" id="" cols="50" rows="5"></textarea>
                <div class="invalid-feedback">
                    Please enter your shipping address.
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title " id="exampleModalLongTitle"><b>Modal title</b> </h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary"> <a href="{{ route('home') }}"> Save
                            changes</a></button>
                </div>
            </div>
        </div>
